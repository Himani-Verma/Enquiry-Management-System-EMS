...
export default function LoginPage() {
 ...
 <div className="absolute top-20 left-10 w-96 h-96 bg-blue-200/20 rounded-full blur-3xl animate-float"></div>
 <div className="absolute bottom-20 right-10 w-[500px] h-[500px] bg-indigo-200/20 rounded-full blur-3xl animate-float-delay"></div>
 <div className="absolute top-1/2 left-1/3 w-80 h-80 bg-purple-200/15 rounded-full blur-3xl animate-float-delay-2"></div>
 </div>
