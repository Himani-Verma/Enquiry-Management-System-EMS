...
export default function ExecutiveAnalyticsPage() {
 ...
 if (!user) {
 console.log('⏳ User not loaded yet, skipping analytics load');
 setLoading(false);
 return;
 }
 setLoading(true);
 ...
 <div className="text-gray-900">Loading your analytics...</div>
 </div>
 </div>
 </div>
 );
 ...
 <DashboardHeader userRole="executive" userName={user?.name} />
 <div className="flex-1 p-6">
 <div className="text-gray-900">No analytics data available</div>
 </div>
 </div>
 </div>
 );
 ...
 <p className="text-gray-900">Real-time performance data from your visitors and enquiries</p>
 </div>
 ...
 <div className="ml-4">
 <p className="text-sm font-medium text-gray-900">Visitors Handled</p>
 ...
 <div className="ml-4">
 <p className="text-sm font-medium text-gray-900">Enquiries Added</p>
 ...
 <div className="ml-4">
 <p className="text-sm font-medium text-gray-900">Leads Converted</p>
 ...
 <p className="text-xs text-gray-800">{activity.service}</p>
 </div>
 <div className="text-right">
 <p className="text-xs text-gray-800">{activity.date}</p>
 ...
 <div className="text-center py-4 text-gray-800">No recent activity</div>
 )}
 </div>
 </div>
 </div>
