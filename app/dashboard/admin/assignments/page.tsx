...
export default function AdminAssignmentsPage() {
 ...
 <div className="text-gray-900">Loading assignment statistics...</div>
 </div>
 </div>
 </div>
 );
 ...
 <button
 onClick={loadStats}
 className="mt-2 px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700 transition-all duration-200 hover:scale-105"
 >
 Retry
 </button>
 </div>
 ...
 <p className="text-gray-900">Monitor and control visitor assignment system</p>
 </div>
 ...
 className="px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 hover:scale-105"
 >
 ...
 className="px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 hover:scale-105"
 >
 ...
 className="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 hover:scale-105"
 >
