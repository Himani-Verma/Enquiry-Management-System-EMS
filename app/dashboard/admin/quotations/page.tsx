...
export default function QuotationsPage() {
 ...
 // Convert MongoDB quotations to SavedQuotation format
 ...
 // Load quotations from MongoDB on mount
 useEffect(() => {
 loadQuotations()
 }, [])
 ...
 // Create new quotation in MongoDB
 ...
 console.log('📤 Sending quotation data:', payload)
 ...
 // Reload quotations from database
 ...
 // Update existing quotation in MongoDB
 const { attachments, ...quotationWithoutAttachments } = quotation
 ...
 // Open preview which has PDF download button
 setPreviewQuotation(quotation.fullData)
 setIsPreviewOpen(true)
 }
