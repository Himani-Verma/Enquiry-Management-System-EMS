...
export default function SalesExecutiveQuotationsPage() {
 ...
 <Sidebar userRole="sales-executive" userName={user?.name} />
 <div className="flex-1 flex flex-col overflow-hidden">
 <DashboardHeader userRole="sales-executive" userName={user?.name} />
 ...
 return (
 <div className="flex h-screen bg-gray-100">
 <Sidebar userRole={user?.role as 'admin' | 'executive' | 'sales-executive' | 'customer-executive' || 'sales-executive'} userName={user?.name} />
 <div className="flex-1 flex flex-col overflow-hidden">
 <DashboardHeader
 userRole={user?.role as 'admin' | 'executive' | 'sales-executive' | 'customer-executive' || 'sales-executive'}
 userName={user?.name}
 />
