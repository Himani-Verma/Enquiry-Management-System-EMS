...
async function getEnquiriesManagementData(request: NextRequest, user: any) {
  try {
    console.log('🔄 GET /api/analytics/sales-executive-enquiries - Fetching enquiries management data');
...
export const GET = async (request: NextRequest) => {
  try {
    console.log('📥 GET request received for sales-executive-enquiries');
