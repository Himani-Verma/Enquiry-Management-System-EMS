...
export async function POST(request: NextRequest) {
 ...
 region,
 assignedAgent,
 addedBy, // Agent ID who is adding this enquiry
 addedByName // Agent name who is adding this enquiry
 } = body;
 ...
 // Update existing visitor - IMPORTANT: Update service field if provided
 ...
 status: 'new',
 priority: 'medium',
 assignedAgent: assignedAgent && assignedAgent.match(/^[0-9a-fA-F]{24}$/) ? assignedAgent : null,
 agentName: assignedAgent || null,
 // Track who added this enquiry
 addedBy: addedBy && addedBy.match(/^[0-9a-fA-F]{24}$/) ? addedBy : null,
 ...
 console.log(`📊 Enquiry added by agent: ${addedByName || 'Unknown'} (ID: ${addedBy || 'N/A'})`);
