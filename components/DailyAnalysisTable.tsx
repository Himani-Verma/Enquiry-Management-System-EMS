...
export default function DailyAnalysisTable({ data, height = 320, className = '' }: DailyAnalysisTableProps) {
 ...
 return (
 <div className={`bg-gradient-to-br from-white to-blue-50/30 rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-lg transition-all duration-300 ${className}`} style={{ minHeight: `${height}px` }}>
 <div className="p-6">
 ...
 <p className="text-sm text-gray-800">Activity overview and insights</p>
 </div>
 </div>
 ...
 return (
 <div className={`bg-gradient-to-br from-white to-blue-50/30 rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-lg hover:border-blue-200 transition-all duration-300 group ${className}`} style={{ minHeight: `${height}px` }}>
 {/* Header */}
 ...
 <p className="text-sm text-gray-800">Last 7 days activity overview</p>
 </div>
 </div>
 ...
 <div className="text-xs text-gray-800">Visitors</div>
 </div>
 ...
 <div className="text-xs text-gray-800">Enquiries</div>
 </div>
 ...
 <div className="text-xs text-gray-800">Messages</div>
 </div>
 ...
 {visitor.phone && (
 <p className="text-sm text-gray-900 mt-1">{visitor.phone}</p>
 )}
 {visitor.location && (
 ...
 <span className="text-xs text-gray-700 whitespace-nowrap ml-3 bg-gray-100 px-2 py-1 rounded">
 ...
 <th className="px-6 py-4 text-left text-xs font-semibold text-gray-900 uppercase tracking-wider">Activity</th>
 <th className="px-6 py-4 text-left text-xs font-semibold text-gray-900 uppercase tracking-wider">Visitors</th>
 <th className="px-6 py-4 text-left text-xs font-semibold text-gray-900 uppercase tracking-wider">Enquiries</th>
 <th className="px-6 py-4 text-left text-xs font-semibold text-gray-900 uppercase tracking-wider">Messages</th>
 <th className="px-6 py-4 text-left text-xs font-semibold text-gray-900 uppercase tracking-wider">Conversion</th>
 </tr>
 </thead>
 ...
 <span className="ml-2 text-xs text-gray-800">visitors</span>
 </div>
 </td>
 <td className="px-6 py-4 whitespace-nowrap">
 <div className="flex items-center">
 <span className="text-xl font-bold text-green-600">{item.enquiries}</span>
 <span className="ml-2 text-xs text-gray-800">enquiries</span>
 </div>
 </td>
 <td className="px-6 py-4 whitespace-nowrap">
 <div className="flex items-center">
 <span className="text-xl font-bold text-purple-600">{item.messages}</span>
 <span className="ml-2 text-xs text-gray-800">messages</span>
 </div>
 </td>
 <td className="px-6 py-4 whitespace-nowrap">
