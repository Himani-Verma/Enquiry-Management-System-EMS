...
export default function ConversationRatioChart({ visitors, leadsConverted, height = 300, className = '' }: ConversationRatioChartProps) {
 ...
 if (visitors === 0) {
 return (
 <div className={`bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-all duration-300 group h-full flex flex-col ${className}`} style={{ minHeight: `${height}px` }}>
 ...
 <div className="text-sm text-gray-900">Conversion Rate</div>
 </div>
 </div>
 ...
 <div className="text-sm text-gray-900">Total Visitors</div>
 </div>
 ...
 <div className="text-sm text-gray-900">Leads Converted</div>
 </div>
 </div>
 </div>
 );
