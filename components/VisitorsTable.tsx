...
export default function VisitorsTable() {
 ...
 <span className="ml-3 text-gray-900">Loading visitors...</span>
 </div>
 </div>
 );
 }
 ...
 <div>
 <h2 className="text-2xl font-bold text-gray-900">Recent Visitors</h2>
 <p className="text-gray-900 mt-1">View all visitors and their information</p>
 </div>
 ...
 className="w-full sm:w-64 px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-900"
 />
 <svg className="absolute right-3 top-2.5 h-5 w-5 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 ...
 <div className="text-sm text-gray-800">{visitor.phone || 'N/A'}</div>
 </td>
 <td className="px-6 py-4 whitespace-nowrap">
 ...
 <td className="px-6 py-4 whitespace-nowrap">
 <div className="text-sm text-gray-900">
 {visitor.salesExecutiveName || 'N/A'}
 </div>
 </td>
 <td className="px-6 py-4 whitespace-nowrap">
 <div className="text-sm text-gray-900">
