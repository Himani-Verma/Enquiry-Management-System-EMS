...
export default function ChatbotWidget({ isOpen, onToggle, isIframe = false }: ChatbotWidgetProps) {
 ...
 <button className="text-white/80 hover:text-white transition-colors duration-200 p-0.5 rounded hover:bg-white/10">
 <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 12h16M4 18h16" />
 </svg>
 </button>
 <div className="flex items-center justify-center flex-1">
 <Image src="/envirocare-logo.png" alt="Envirocare Labs" width={100} height={25} className="drop-shadow-sm" />
 </div>
 {!isIframe && (
 <button
 onClick={onToggle}
 className="text-white/80 hover:text-white transition-colors duration-200 p-0.5 rounded hover:bg-white/10"
 >
 <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
