...
export default function HeaderPartiesTab({ 
 ...
 disabled={true}
 className="w-full px-4 py-3 rounded-lg border-2 bg-gray-100 text-gray-900 font-bold placeholder-gray-400 cursor-not-allowed border-gray-300"
 placeholder="Auto-generated"
 readOnly
 />
 <div className="absolute right-3 top-1/2 -translate-y-1/2">
 <span className="inline-flex items-center px-3 py-1 rounded-md bg-blue-100 text-blue-700 text-xs font-semibold">
 Auto-Generated
 </span>
 </div>
 </div>
 <p className="mt-1 text-xs text-gray-800">
 Quotation number is automatically generated and unique
 </p>
 </div>
 ...
 />
 <span className="text-sm" style={{ color: 'var(--text-gray-900)' }}>
 Copy from Bill To
 </span>
 </label>
 </div>
