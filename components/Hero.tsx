export default function Hero() {
 ...
 <p className="text-lg text-gray-900 mb-6 max-w-2xl">
 ...
 <div className="text-xs text-gray-900">Since 1979</div>
 </div>
 <div className="bg-white rounded-lg shadow-md p-4 text-center">
 <div className="text-2xl font-bold text-blue-600 mb-1">Testing</div>
 <div className="text-xs text-gray-900">Parameters</div>
 </div>
 <div className="bg-white rounded-lg shadow-md p-4 text-center">
 <div className="text-2xl font-bold text-blue-600 mb-1">Clientele</div>
 <div className="text-xs text-gray-900">Worldwide</div>
 </div>
 </div>
 </div>
 </div>
 ...
 <p className="text-sm text-gray-900">ISO/IEC 17025 and ISO/IEC 17043 by NABL</p>
 </div>
 ...
 <p className="text-sm text-gray-900">FSSAI, BIS, EIC, APEDA, AGMARK</p>
 </div>
 ...
 <p className="text-sm text-gray-900">Prestigious organizations worldwide</p>
 </div>
 </div>
 </div>
 </div>
