...
export default function RecentConversations({ conversations, height = 320, className = '' }: RecentConversationsProps) {
 ...
 return (
 <div className={`bg-white rounded-lg shadow-sm border border-gray-200 ${className}`} style={{ minHeight: `${height}px` }}>
 <div className="p-4">
 ...
 <span className="text-sm text-gray-800">{conversations.length} visitors</span>
 </div>
